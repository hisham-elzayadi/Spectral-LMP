function [x,flag,relres,iter,resvec,x_hist] = pcg_modified(A,b,tol,maxit,M1,M2,x0,varargin)
...
for ii = 1 : maxit
    ...
    if existM2
        z = iterapp('mldivide',m2fun,m2type,y,varargin{:});
        if ~allfinite(z)
            flag = 2;
            break
        end
